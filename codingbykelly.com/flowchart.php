...
<!-- START Footer -->
<footer>
  <p><small>&copy; 2018 - (insert php date code here) by <a href="#" target="_blank">Kelly Grimes</a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
</footer>
<!-- END Footer --> 
