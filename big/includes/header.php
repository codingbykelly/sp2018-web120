...
<meta charset="utf-8"><script src="http://code.jquery.com/jquery-latest.min.js" type="text/javascript"></script>
...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa fa-home"></i> Kelly's Web Dev Examples WEB120 Portal</a></h1>
  <nav id="cssmenu">
  <ul>
